...
export class BrochureComponent
{
  ...
  editedbrochure: BrochureViewModel;
  private editService: BrochureService;
  private editedRowIndex: number;

  constructor( @Inject(BrochureService) editServiceFactory: any)
  {
  ...
  public addHandler({ sender }, formInstance) {
    ...
    var newBrochure = new BrochureViewModel();
